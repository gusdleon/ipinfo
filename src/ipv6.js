        ...
        try {
            ...
            if (!ip) {
                return new Response(JSON.stringify({
                    error: {
                        code: 'MISSING_IP',
                        message: 'IPv6 address is required in the URL path'
                    },
            ...
            if (ipv6Regex.test(ip)) {
                ...
                return new Response(JSON.stringify({
                    error: {
                        code: 'INVALID_IPV6',
                        message: 'Invalid IPv6 address format. Please provide a valid IPv6 address.',
                        provided: ip
                    },
                    timestamp: new Date().toISOString()
                }), {
            ...
            return new Response(JSON.stringify({
                error: {
                    ...
                    message: 'An error occurred while processing the IPv6 request',
